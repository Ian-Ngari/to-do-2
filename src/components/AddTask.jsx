    ...
    <div className="mb-6">
      {isAdding ? (
        ...
        <button
          ...
          className="w-full py-3 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 rounded-lg shadow transition flex items-center justify-center space-x-2"
        >
